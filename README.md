...
本仓库当前包含 HarmonyOS 移动端工程、后端服务和项目设计文档。移动端已具备中心化工作台、登录、设备档案查询、二维码查询、状态核验、档案变更申请与审核、故障报告、维修接取、维修报告、复检任务和操作记录等基础页面与本地运行闭环；后端服务已提供认证、设备查询、二维码防伪校验、设备档案变更审核、故障接取、维修报告、复检和审计日志的首批 API 工作流。
