...
本仓库当前包含 HarmonyOS 移动端工程、Spring Boot 后端服务和项目设计文档。移动端已具备中心化工作台、登录、设备档案查询、二维码查询、状态核验、档案变更申请与审核、故障报告、维修接取、维修报告、复检任务和操作记录等基础页面与本地运行闭环；Spring Boot 后端已提供认证、工作台概览、设备档案查询、二维码防伪校验、设备档案变更申请、管理员审核、故障报告、维修接取、维修报告和复检记录等 API。
