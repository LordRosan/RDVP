...
public class JdbcRecordCenterRepository implements RecordCenterRepository {
    ...
    public RecordListResponse queryArchiveRecords(String type, String keyword, int limit, int offset) {
        ...
        List<RecordItemResponse> items = jdbcTemplate.query(
                """
                        SELECT
                            ...
                            cr.id AS task_no,
                            cr.applicant_id AS operator_name,
        ...
        return new RecordListResponse(items, countRecords(
                "device_change_requests cr LEFT JOIN devices d ON d.id = cr.device_id",
                where,
                parameters));
    }
        ...
        // device_verification_records
        {
            ...
            sql.append("""
                    SELECT
                        ...
                        dvrd.device_code,
                        dvr.id AS task_no,
                        dvr.operator_id AS operator_name,
        ...
        // fault_reports
        {
            ...
            sql.append("""
                    SELECT
                        ...
                        fr.reporter_id AS operator_name,
                        fr.occurred_at,
        ...
        // repair_tasks
        {
            ...
            sql.append("""
                    SELECT
                        ...
                        rt.maintainer_id AS operator_name,
        ...
        // repair_reports
        {
            ...
            sql.append("""
                    SELECT
                        ...
                        rr.maintainer_id AS operator_name,
        ...
        // reinspection_records
        {
            ...
            sql.append("""
                    SELECT
                        ...
                        ri.reinspector_id AS operator_name,
