...
@Repository
@Profile("!test")
public class JdbcArchiveRequestRepository implements ArchiveRequestRepository {

    private static final TypeReference<Map<String, ArchiveFieldChange>> CHANGE_MAP_TYPE = new TypeReference<>() {
    };

    private final NamedParameterJdbcTemplate jdbcTemplate;
    private final ObjectMapper objectMapper;

    public JdbcArchiveRequestRepository(
    ...
    public Optional<ArchiveRequest> findById(String id) {
        List<ArchiveRequest> results = jdbcTemplate.query(
    ...
    public ArchiveRequestPage list(ArchiveRequestQuery query) {
        ...
        List<ArchiveRequest> items = jdbcTemplate.query(
        ...
        Long total = jdbcTemplate.queryForObject(
                ...
                parameters,
                Long.class);
        return new ArchiveRequestPage(items, total == null ? 0 : total);
    }
    ...
    private String buildWhereClause(ArchiveRequestQuery query, MapSqlParameterSource parameters) {
    ...
    private ArchiveRequest mapArchiveRequest(ResultSet resultSet, int rowNumber) throws SQLException {
        Map<String, ArchiveFieldChange> changes = readChanges(resultSet.getString("changes"));
        return new ArchiveRequest(
                resultSet.getString("id"),
                ArchiveRequestType.valueOf(resultSet.getString("request_type")),
                ...
                null,
                ArchiveRequestStatus.valueOf(resultSet.getString("status")),
    ...
    private String resolveDeviceName(String deviceName, Map<String, ArchiveFieldChange> changes) {
        if (deviceName != null && !deviceName.isBlank()) {
            return deviceName;
        }

        ArchiveFieldChange nameChange = changes.get("name");
    ...
    private String writeChanges(Map<String, ArchiveFieldChange> changes) {
        try {
    ...
    private Map<String, ArchiveFieldChange> readChanges(String changesJson) {
        try {
