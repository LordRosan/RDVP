...
UPDATE device_change_requests cr
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_device_change_requests_pending_target_code
    ON device_change_requests(target_device_code)
