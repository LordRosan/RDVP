...
class AuthControllerTests {
    ...
    void seedsIssueDefinedRoleAccountsWithExpectedPermissions() throws Exception {
        assertUserPermissions("admin", "superadmin",
                "ARCHIVE_CENTER_ARCHIVE_QUERY",
                "ARCHIVE_CENTER_ARCHIVE_CREATE_REQUEST_SUBMIT",
                "ARCHIVE_CENTER_ARCHIVE_UPDATE_REQUEST_SUBMIT",
                "ARCHIVE_CENTER_ARCHIVE_DELETE_REQUEST_SUBMIT",
                "ARCHIVE_CENTER_ARCHIVE_EXPORT",
                ...
                "REVIEW_CENTER_ARCHIVE_REQUEST_REVIEW",
