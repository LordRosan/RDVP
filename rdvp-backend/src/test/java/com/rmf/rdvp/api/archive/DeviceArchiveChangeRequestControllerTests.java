...
class DeviceArchiveChangeRequestControllerTests {
    ...
    void listsPendingChangeRequestsForReviewer() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/device-archive-change-requests?status=PENDING_REVIEW")
                        .header("Authorization", "Bearer " + token))
                .andExpect(status().isOk())
    ...
    void approvesChangeRequestAndAppliesArchiveUpdate() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/device-archive-change-requests/{requestId}/review", requestId)
    ...
    void rejectsRepeatedChangeRequestReview() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/device-archive-change-requests/{requestId}/review", requestId)
                        ...
                        .content("""
                                ...
                                """))
                .andExpect(status().isConflict())
                .andExpect(jsonPath("$.error.code").value("DEVICE_ARCHIVE_CHANGE_REQUEST_ALREADY_REVIEWED"));
    }
    ...
    void rejectsDeleteRequestWithoutRecentPasswordVerification() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/device-archive-change-requests")
                        .header("Authorization", "Bearer " + token)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
        ...
        mockMvc.perform(get("/api/v1/audit-logs?action=DEVICE_ARCHIVE_CHANGE_REQUEST&keyword=device-local-0001")
    ...
    void rejectsDuplicatePendingChangeRequest() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/device-archive-change-requests")
                        ...
                        .content("""
                                ...
                                """))
                .andExpect(status().isConflict())
                .andExpect(jsonPath("$.error.code").value("DEVICE_ARCHIVE_CHANGE_LOCKED"));
    }
    ...
    void rejectsFrozenArchiveChangeRequest() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/device-archive-change-requests")
                        ...
                        .content("""
                                ...
                                """))
                .andExpect(status().isConflict())
                .andExpect(jsonPath("$.error.code").value("DEVICE_ARCHIVE_CHANGE_FROZEN"));
    }
    ...
    private String createNameChange(String token, String newName) throws Exception {
        String response = mockMvc.perform(post("/api/v1/device-archive-change-requests")
                        .header("Authorization", "Bearer " + token)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
